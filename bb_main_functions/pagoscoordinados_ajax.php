...
{
	$("#aceptaimpCoo").click( function()
   	{		
		$('#bitacora1').hide(0);
		popUpOper($(this),"impCoo");
	});
...
function modSubmit ($submit)
{
	...
	$submit=str_replace("ONCLICK=\"parent.history.back()\"","ONCLICK=\"iniProcesarMenu('pagoscoordinados', '')\"",$submit);
	...
	$procesarAjax="<script>
						...
						function procesarAjax()
						{
							...
							{
								document.frmApplet.Datos1.value= document.AppEntidades.appEnviaDatos();
								document.frmApplet.DatosImp.value=document.AppEntidades.appEnviaImpresion();
								document.frmApplet.CadOrig.value=document.AppEntidades.appEnviaCadOriginal();
								...
								if (document.frmApplet.Datos1.value == '*')
								{
									window.alert('Debe cerrar la ventana de dialogo.'); return false;
								}
							}
							...
							iniProcesarMenu('pagoscoordinados', parametros);
						}
				</script>";
...
$DomainPostfix = $ini->read_var( "site", "DomainPostfix" );
    ...
    $transaccion_buffer = "";
    //ATAR Bloqueo de recepcion de pagos Anuales
    $mensaje_sat = "";
	/**************
	ATAR I 05Mar2013 se bloquea recepcion de pagos coordinados para Persfis, perfacem y gobierno 04Mar2013
	***************/
	// $mensaje_sat = "";
	...
	// {	
		// $mensaje_sat="<table width='80%' height='62' border='1' align='center' cellpadding='5' cellspacing='0'><tr><tr><td colspan='0' align='center'>Sr. Contribuyente, el SAT le informa:<br>A partir de julio del 2013 est&aacute; obligado a utilizar el Servicio de Pago Referenciado para presentar sus pagos coordinados o definitivos de impuestos federales, no debe de utilizar el esquema anterior de pagos electr&oacutenicos.</td></tr></tr></table>";					
		// $noPagProv=1;
	// }	
	/**************
	ATAR F 05Mar2013 se bloquea recepcion de pagos coordinados para Persfis, perfacem y gobierno 04Mar2013
	***************/
    $mensaje_sat="<table width='80%' height='62' border='1' align='center' cellpadding='5' cellspacing='0'><tr><td colspan='0' align='center'>Sr. Contribuyente, el SAT le informa:<br>A partir de Agosto del 2014 est&aacute; obligado a utilizar el Servicio de Pago Referenciado para presentar sus pagos Coordinados E. Federativas o definitivos de impuestos federales, no debe de utilizar el esquema anterior de pagos electr&oacutenicos.</td></tr></table>";		
    $noPagProv=1;
	if($noPagProv == 0)
	{
    ...
    $transaccion_buffer=$t->parse( "output", "pagoscoordinados_tpl" );
