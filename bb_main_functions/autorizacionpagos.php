...
if ( $user )
{
    ...
    $t = new eZTemplate( "eztransaccion/user/" . $ini->read_var( "eZTransaccionMain", "TemplateDir" ),
                         "eztransaccion/user/intl/", $Language, "AutorizacionPagos.php" );

    $t->setAllStrings();

    $t->set_file( array(
        "AutorizacionPagos_tpl" => "AutorizacionPagos.tpl"
        ) );
    ...
    $t->pparse( "output", "AutorizacionPagos_tpl" );

    $usr = strtolower($usr);   
//        include("eztransaccion/user/include/pagosporautorizar.inc");

    $result = ControlAcceso("autpag",$usr);    
