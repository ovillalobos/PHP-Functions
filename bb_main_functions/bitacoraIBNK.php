...
if ( $user )
{
    $t = new eZTemplate( "eztransaccion/user/" . $ini->read_var( "eZTransaccionMain", "TemplateDir" ),
                         "eztransaccion/user/intl/", $Language, "bitacoraIBNK.php" );

    $t->setAllStrings();

    $t->set_file( array(
        "bitacoraIBNK_tpl" => "bitacoraIBNK.tpl"
        ) );
    ...
    $t->pparse( "output", "bitacoraIBNK_tpl" );
}
else
{
    $t = new eZTemplate( "eztransaccion/user/" . $ini->read_var( "eZTransaccionMain", "TemplateDir" ),
    ...
    $t->set_var( "redirect_url", "/transaccion/bitacoraIBNK/" );
