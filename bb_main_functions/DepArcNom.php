...
if ( $user )
{
    $t = new eZTemplate( "eztransaccion/user/" . $ini->read_var( "eZTransaccionMain", "TemplateDir" ),
                         "eztransaccion/user/intl/", $Language, "DepArcNom.php" );

    $t->setAllStrings();

    $t->set_file( array(
        "DepArcNom_tpl" => "DepArcNom.tpl"
        ) );
    ...
    case "FrAc":
        ...
        if (isset($_POST['Accion'])) {
            setcookie ( "QueAccion", $_POST['Accion'], time() + ( 3600 * 24 * 365 ), "/",  "bb.com.mx", 0 ) or print( "Error: could not set cookie." );
        }
	 ...
	 if ( $_POST['Agrupa']=="Aceptar" )
	 {
		...
		$_POST['Accion']  = "DepNom";
        	$_POST['DiasPzo'] = "";
        	$particularFields = "&Accion=".urlencode($_POST['Accion'])."&FrAccount=".urlencode($_POST['FrAccount'])."&Button=".urlencode($_POST['Button'])."&AgruPagIni=".urlencode($_POST['AgruPagIni']);
        	$tr->blog($qki,"DepNom", $_POST['FrAccount'], $_POST['ToAccount'], $_POST['DiasPzo'], $_POST['Parent1'], $_POST['Accion']);
    ...
    $t->set_var( "redirect_url", "/transaccion/DepArcNom/" );
