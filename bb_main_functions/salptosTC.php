...
if ( $user )
{
    $t = new eZTemplate( "eztransaccion/user/" . $ini->read_var( "eZTransaccionMain", "TemplateDir" ),
                         "eztransaccion/user/intl/", $Language, "salptosTC.php" );

    $t->setAllStrings();

    $t->set_file( array(
        "salptosTC_tpl" => "salptosTC.tpl"
        ) );
    ...
    if( ! $hubo_error ) {
        $particularFields .= "&Accion=SalPtos";
		$Access = "Process";
    ...
    $t->set_var( "redirect_url", "/transaccion/salptosTC/" );
