...
//	echo "YEHO autposttohost Accion[$Accion] Access[$Access] particularFields[$particularFields]";
    $ret_code = $tr->PostToHost($backend, "/IBnkIIS.dll", "Trxn=aus&Access=".urlencode($Access)."&CustID=".urlencode($usr)."&Cadpriv=".urlencode($priv).$particularFields, $qki, $usr, $qki, $priv, $transaccion_buffer); // autorizacion de operaciones pendientes
//////////////////// YEHO I 13Abr2011
if ($Access == "Process")
	{
