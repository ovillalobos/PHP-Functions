...
($parametros['TeleB']!=""?$TeleB=$parametros['TeleB']:0);
($parametros['PlazaB']!=""?$PlazaB=$parametros['PlazaB']:0);
($parametros['RFC']!=""?$RFC=$parametros['RFC']:0);
($parametros['Pagar']!=""?$Pagar=$parametros['Pagar']:0);
($parametros['Msg']!=""?$Msg=$parametros['Msg']:0);
($parametros['Empresa']!=""?$Empresa=$parametros['Empresa']:0);
($parametros['framount']!=""?$framount=$parametros['framount']:0);
($parametros['toamount']!=""?$toamount=$parametros['toamount']:0);
($parametros['Parent1']!=""?$Parent1=$parametros['Parent1']:0);
($parametros['estado']!=""?$estado=$parametros['estado']:0);
($parametros['Parent2']!=""?$Parent2=$parametros['Parent2']:0);
($parametros['Recargo']!=""?$Recargo=$parametros['Recargo']:0);
($parametros['ValEsp']!=""?$ValEsp=$parametros['ValEsp']:0);
($parametros['Descuento']!=""?$Descuento=$parametros['Descuento']:0);
...
include_once( "ezreimp/classes/ezreimp.php" ); //DBA Reimpresion de Comprobantes
	function modSubmit ($submit)
	{
		...
		$submit=str_replace("type=\"submit\"","type=\"button\" onclick=\"procesarAjax();\"",$submit);
		$submit=str_replace("parent.history.back()","iniProcesarMenu('pagoservicios', '');",$submit);
	...
	$procesarAjax="
					<script>
						...
						function procesarAjax()
						{
							...
							{
								parametros+=',RenCap:'+document.getElementsByName('RenCap')[0].value;
							}
							...
							if(document.getElementsByName('TeleB')[0]!=null)
							{
								parametros+=',TeleB:'+document.getElementsByName('TeleB')[0].value;
							}

							if(document.getElementsByName('PlazaB')[0]!=null)
							{
								parametros+=',PlazaB:'+document.getElementsByName('PlazaB')[0].value;
							}
							...
							if(document.getElementsByName('Pagar')[0]!=null)
							{
								parametros+=',Pagar:'+document.getElementsByName('Pagar')[0].value;
							}

							if(document.getElementsByName('Msg')[0]!=null)
							{
								parametros+=',Msg:'+document.getElementsByName('Msg')[0].value;
							}
							...
							if(document.getElementsByName('framount')[0]!=null)
							{
								parametros+=',framount:'+document.getElementsByName('framount')[0].value;
							}

							if(document.getElementsByName('toamount')[0]!=null)
							{
								parametros+=',toamount:'+document.getElementsByName('toamount')[0].value;
							}

							if(document.getElementsByName('Parent1')[0]!=null)
							{
								parametros+=',Parent1:'+document.getElementsByName('Parent1')[0].value;
							}
							...
							if(document.getElementsByName('Parent2')[0]!=null)
							{
								parametros+=',Parent2:'+document.getElementsByName('Parent2')[0].value;
							}

							if(document.getElementsByName('Recargo')[0]!=null)
							{
								parametros+=',Recargo:'+document.getElementsByName('Recargo')[0].value;
							}

							if(document.getElementsByName('ValEsp')[0]!=null)
							{
								parametros+=',ValEsp:'+document.getElementsByName('ValEsp')[0].value;
							}

							if(document.getElementsByName('Descuento')[0]!=null)
							{
								parametros+=',Descuento:'+document.getElementsByName('Descuento')[0].value;
							}
							...
							iniProcesarMenu('pagoservicios', parametros);
    ...
    //$t->pparse( "output", "pagoservicios_tpl" );  ACS
    $transaccion_buffer=$t->parse( "output", "pagoservicios_tpl" );
