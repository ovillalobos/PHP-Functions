...
include_once("eztransaccion/user/include/controles_javascript.inc");
	...
	if($_POST['Access'] != "TipoCambio")
	{
		...
		echo "<h1>Recargas Visa Travel Money</h1>";
	...
	//NEXAJAX - Instrucciones para consumir ProcesarAjax
		...
		case "FrAc":
			include("eztransaccion/user/include/recargavtm_frac.inc");
			break;
			//SEccion para seleccionar las cuentas de la operación
		case "FrAc2":
			include("eztransaccion/user/include/recargavtm_frac2.inc");
			break;
		case "Process":
			include("eztransaccion/user/include/recargavtm_process.inc");
			break;
		case "TipoCambio":
			include("eztransaccion/user/include/recargavtm_tipocambio.inc");
			break;
