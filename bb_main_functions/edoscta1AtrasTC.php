...
if ( $user )
{
    $t = new eZTemplate( "eztransaccion/user/" . $ini->read_var( "eZTransaccionMain", "TemplateDir" ),
                         "eztransaccion/user/intl/", $Language, "edoscta1AtrasTC.php" );

    $t->setAllStrings();

    $t->set_file( array(
        "edoscta1AtrasTC_tpl" => "edoscta1AtrasTC.tpl"
        ) );
    ...
    $particularFields = "&PAN=" . urlencode($tarjeta)."&Empresa=02";
    ...
    $t->pparse( "output", "edoscta1AtrasTC_tpl" );
    // phpinfo();
} else {
    $t = new eZTemplate( "eztransaccion/user/" . $ini->read_var( "eZTransaccionMain", "TemplateDir" ),
    ...
    $t->set_var( "redirect_url", "/transaccion/edoscta1AtrasTC/" );
