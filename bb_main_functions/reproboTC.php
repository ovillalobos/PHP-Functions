...
if ( $user )
{
    $t = new eZTemplate( "eztransaccion/user/" . $ini->read_var( "eZTransaccionMain", "TemplateDir" ),
                         "eztransaccion/user/intl/", $Language, "reproboTC.php" );

    $t->setAllStrings();

    $t->set_file( array(
        "reproboTC_tpl" => "reproboTC.tpl"
        ) );
...
//HB
    ...
    case "Confirm":
    case "Process":
            $Operacion = "Robo";	//FAF Cambio Nuevo Menu
    ...
    $t->set_var( "redirect_url", "/transaccion/reproboTC/" );
